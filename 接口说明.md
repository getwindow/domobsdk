...
| String | name | 广告名字 |
| int | task_index | 可做任务的index，可通过这个index去|
| double | point | 广告积分 |
| String | ver | 广告版本号 |
| String | size | 广告安装包大小 |
| String | tasks | 深度任务列表 |
| String | setup_tips | 任务提示信息 |
| String | thumbnail | 广告详情页的图片 |
| boolean | executable | 是否可做任务 |
| String | tasks | 任务对象集合，每一个Item为一个任务|
| String | thumbnail | 广告详情页的图片 |
| boolean | open_detail | 表示是否打开详情页，或直接触发|
| boolean | is_done | 任务是否已完成 |
| String | executable_date | 任务可完成时间 |
